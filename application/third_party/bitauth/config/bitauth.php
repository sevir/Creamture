...
/**
 * Table ids used by BitAuth
 */
$config['table_ids'] = array(
	'users'		=> 'user_id',		// Required user information (username, password, etc)
	'data'		=> 'userdata_id',	// Optional user information (profile)
	'groups'	=> 'group_id',	// Groups
	'assoc'		=> 'assoc_id',		// Users -> Groups associations
	'logins'	=> 'login_id'		// Record of all logins
);
